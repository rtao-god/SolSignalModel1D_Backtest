	...
	public static class NyWindowingChecks
		...
		public static IReadOnlyList<string> RunBasic ()
			...
			try
				...
				var winterExitUtc = CoreNyWindowing.ComputeBaselineExitUtc (winterEntryUtc, nyTz);
				...
				var summerExitUtc = CoreNyWindowing.ComputeBaselineExitUtc (summerEntryUtc, nyTz);
