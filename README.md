...
Бэктест дневной модели для монеты **SOLUSDT**, которая в фиксированное время (08:00 по Нью-Йорку, но для удобства всё пересчитано в UTC, чтобы исключить сезонные колебания времени (DST)) пытается предсказать, что будет с ценой в ближайшие 24 часа: **обвал**, **боковик** или **рост**.  
