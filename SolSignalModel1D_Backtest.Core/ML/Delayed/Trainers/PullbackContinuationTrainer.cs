			...
			foreach (var s in samples)
				...
				if (s.Features.Length != MlSchema.FeatureCount)
					...
					throw new InvalidOperationException (
						$"[A-trainer] Features length mismatch for sample entry={s.EntryUtc:O}: " +
				...
				// Клонируем массив, чтобы обучающий датасет не зависел от возможных внешних мутаций sample.Features.
