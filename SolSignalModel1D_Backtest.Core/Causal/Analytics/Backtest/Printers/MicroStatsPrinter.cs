...
namespace SolSignalModel1D_Backtest.Core.Causal.Analytics.Backtest.Printers
	...
	public static class MicroStatsPrinter
		{
		public static void Print ( IReadOnlyList<DataRow> mornings, IReadOnlyList<BacktestRecord> records )
			{
		...
		private static void PrintNonFlatDirection ( IReadOnlyList<BacktestRecord> records )
			{
